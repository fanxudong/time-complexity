...
public class binaryPlot extends ApplicationFrame 
{
   public binaryPlot( String applicationTitle, String chartTitle )
   {
...
private XYDataset createDataset( )
   {
      ...
      for(int i=1;i<=500;i+=10){
    	 ...
    	 /* for(int i=0;i<15;i++){
    	  ...
    	  tab=quickSort.sort(tab);
    	 /* for(int i=0;i<15;i++){
        	  System.out.println(tab[i]);
    	  }*/
    	  int res;
    	  long startTime=System.nanoTime();
    	  Dichotomy.indexOfOrdered(tab,0);
   ...
   {
      binaryPlot chart = new binaryPlot("binary search", "binary search");
      chart.pack( );          
